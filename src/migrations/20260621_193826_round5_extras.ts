...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_payload_locked_documents_rels\`("id", "order", "parent_id", "path", "users_id", "services_id", "products_id", "testimonials_id", "posts_id", "leads_id", "plans_id") SELECT "id", "order", "parent_id", "path", "users_id", "services_id", "products_id", "testimonials_id", "posts_id", "leads_id", "plans_id" FROM \`payload_locked_documents_rels\`;`)
