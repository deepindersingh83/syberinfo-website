  ...
  collections: [
    ...
    // ─── Billing / provisioning platform (Phase 0 foundations) ───
    {
      ...
      admin: {
        useAsTitle: "email",
        group: "Billing",
        defaultColumns: ["name", "company", "email", "phone", "state"],
        description: "Every client in one place. Open a client to see and manage all their services, invoices, tickets, assets and domains.",
      ...
      fields: [
        ...
        // --- Client 360: everything related to this client, managed inline ---
        {
          type: "collapsible",
          ...
          fields: [
            {
              ...
              on: "customer",
              label: "Services / Subscriptions",
              admin: { defaultColumns: ["label", "status", "billingCycle", "recurringAmount", "nextDueDate"], allowCreate: true },
            },
          ],
        },
        {
          ...
          fields: [
            {
              ...
              on: "customer",
              label: "Invoices",
              admin: { defaultColumns: ["number", "total", "status", "dueDate", "paidDate"], allowCreate: true },
            },
            {
              ...
              admin: { defaultColumns: ["reference", "amount", "gateway", "status"], allowCreate: false },
            },
            {
              name: "quotesList",
              type: "join",
              ...
              admin: { defaultColumns: ["number", "title", "total", "status"], allowCreate: true },
            },
          ],
        },
        {
          ...
          fields: [
            {
              ...
              admin: { defaultColumns: ["subject", "status", "priority", "slaDueAt"], allowCreate: true },
            },
            {
              name: "assetsList",
              type: "join",
              collection: "assets",
              on: "customer",
              label: "Assets & licences",
              admin: { defaultColumns: ["name", "category", "renewalDate", "status"], allowCreate: true },
            },
            {
              name: "domainsList",
              type: "join",
              ...
              on: "customer",
              label: "Domains",
              admin: { defaultColumns: ["domain", "status", "expiryDate", "autoRenew"], allowCreate: true },
            },
          ],
        },
      ],
